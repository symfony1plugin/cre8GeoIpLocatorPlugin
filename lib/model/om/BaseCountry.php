  ...
  const PEER = 'CountryPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->printable_name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->iso3 = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->numcode = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->resetModified();
